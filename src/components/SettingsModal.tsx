            ...
            <div className="patient-profile-fields">
              ...
              <div className="patient-profile-field patient-profile-field-wide">
                ...
                <div className="chip-options-row medication-options">
                  <button
                    type="button"
                    className={`chip-select medication-yes ${settings.takesAntihypertensiveMedication ? 'active' : ''}`}
                    onClick={() => handleMedicationChange(true)}
                  >
                    {t('settings.medicationYes')}
                  </button>
                  <button
                    type="button"
                    className={`chip-select medication-no ${!settings.takesAntihypertensiveMedication ? 'active' : ''}`}
                    onClick={() => handleMedicationChange(false)}
                  >
