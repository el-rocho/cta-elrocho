...
export const FlagGB: React.FC<FlagProps> = ({ className = '', size = 18 }) => {
  ...
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <clipPath id="flag-gb-clip-main">
        <path d="M0,0 v30 h60 v-30 z" />
      </clipPath>
      <clipPath id="flag-gb-diag-main">
        <path d="M0,0 L60,30 M60,0 L0,30" stroke="#fff" strokeWidth="6" />
      </clipPath>
      <g clipPath="url(#flag-gb-clip-main)">
        <path d="M0,0 L60,30 M60,0 L0,30" stroke="#00247d" strokeWidth="60" />
        <path d="M0,0 L60,30 M60,0 L0,30" stroke="#ffffff" strokeWidth="10" />
        <path d="M0,0 L60,30 M60,0 L0,30" stroke="#cf142b" strokeWidth="6" clipPath="url(#flag-gb-diag-main)" />
