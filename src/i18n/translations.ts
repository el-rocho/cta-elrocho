...
export const translations = {
  es: {
    ...
    settings: {
      ...
      guidelineDesc: 'La referencia seleccionada cambia las categorías, colores y textos calculados, pero no modifica ninguna medición.',
      guidelineEsc: 'Europea ESC 2024',
      guidelineEscDesc: 'Clasificación específica para medias domiciliarias.',
      guidelineAha: 'Estadounidense AHA/ACC 2025',
      guidelineAhaDesc: 'Categorías estadounidenses aplicadas al registro domiciliario.',
      guidelineIsh: 'Internacional ISH 2020',
      guidelineIshDesc: 'Comparación simplificada con el umbral domiciliario.',
  ...
  en: {
    ...
    settings: {
      ...
      guidelineDesc: 'The selected reference changes calculated categories, colors and text, but never modifies a measurement.',
      guidelineEsc: 'European ESC 2024',
      guidelineEscDesc: 'Classification designed for home blood pressure averages.',
      guidelineAha: 'US AHA/ACC 2025',
      guidelineAhaDesc: 'US categories applied to a home blood pressure log.',
      guidelineIsh: 'International ISH 2020',
      guidelineIshDesc: 'Simplified comparison with the home threshold.',
